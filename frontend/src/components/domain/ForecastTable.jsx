            ...
            {sortedSummaries.map((summary) => {
              ...
              return (
                <>
                  <tr
                    key={summary.sku}
                    className="touch-table-row hover:bg-gray-50 cursor-pointer active:bg-gray-100"
                  ...
                  >
                    <td className="px-4 py-3 text-sm text-gray-500">
                      <button
                        ...
                        className="min-w-[44px] min-h-[44px] flex items-center justify-center text-gray-400 hover:text-gray-600 active:text-gray-800 text-xl"
                      >
                        {isExpanded ? "▼" : "▶"}
                      </button>
                    </td>
